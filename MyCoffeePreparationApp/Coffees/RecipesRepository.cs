...
namespace MyCoffeePreparationApp.Coffees
{
    public class RecipesRepository : ICoffeesRepository
    {
        ...
        public RecipesRepository(StringsXmlRepository stringsXmlRepository)
        {
            StringsXmlRepository = stringsXmlRepository;
        }

        public StringsXmlRepository StringsXmlRepository { get; }
